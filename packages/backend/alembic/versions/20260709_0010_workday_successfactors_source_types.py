"""Add Workday and SAP SuccessFactors source types.
...
SOURCE_TYPE_VALUES = ("WORKDAY", "SAP_SUCCESSFACTORS")
...
def downgrade() -> None:
    raise RuntimeError(
        "20260709_0010 is intentionally irreversible: PostgreSQL enum values "
