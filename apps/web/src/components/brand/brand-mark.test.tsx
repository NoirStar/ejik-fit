...
describe("BrandMark", () => {
  ...
  it("renders one consistent Korean CareerFit wordmark", () => {
    ...
    expect(container.querySelector(".brand-lockup__mark img"))
      .toHaveAttribute("src", expect.stringContaining("ejik-fit-mascot.png"));
    expect(container.querySelector(".brand-lockup__mark")).not.toHaveTextContent("C");
