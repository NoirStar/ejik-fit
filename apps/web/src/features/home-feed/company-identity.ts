...
const VERIFIED_LOGOS: VerifiedLogo[] = [
  ...
  {
    aliases: ["네오플", "neople"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/neople",
    displayName: "네오플",
  },
  {
    aliases: ["넥슨게임즈", "nexon games"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nexon-games",
    displayName: "넥슨게임즈",
  },
  {
    aliases: ["넥슨에이치큐", "nexon hq"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nexon-hq",
    displayName: "넥슨에이치큐",
  },
  {
    aliases: ["데브캣", "devcat"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/devcat",
    displayName: "데브캣",
  },
  {
    aliases: ["민트로켓", "mintrocket", "mint rocket"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/mintrocket",
    displayName: "민트로켓",
  },
  {
    aliases: ["넥슨유니버스", "nexon universe"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nexon-universe",
    displayName: "넥슨유니버스",
  },
  {
    aliases: ["넥슨네트웍스", "nexon networks"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nexon-networks",
    displayName: "넥슨네트웍스",
  },
  {
    aliases: ["넥슨커뮤니케이션즈", "nexon communications"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nexon-communications",
    displayName: "넥슨커뮤니케이션즈",
  },
  {
    aliases: ["엔미디어플랫폼", "nmedia platform"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nmedia-platform",
    displayName: "엔미디어플랫폼",
  },
  {
    aliases: ["딜로퀘스트", "diloquest"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/diloquest",
    displayName: "딜로퀘스트",
  },
  {
    aliases: ["넥슨스페이스", "nexon space"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nexon-space",
    displayName: "넥슨스페이스",
  },
  {
    aliases: ["엔엑스씨", "nxc"],
    hosts: ["careers.nexon.com"],
    src: "/company-logo-assets/nxc",
    displayName: "엔엑스씨",
  },
  {
